...
I'm the Co-Founder and Full Stack Developer at **[Lulos Impulso Digital](https://tri-devs.vercel.app/)**, where we build web platforms, applications and drive technical and local SEO for clients like **[CIT](https://transitocitcali.com/)** • **[GastroGest Pro](https://gastrogestpro.com/)** • **[Tiffany Esthetic Group](https://tiffany-esthetic-group-ips-sas.vercel.app/)** we've delivered measurable results — including 48,000+ search impressions, 708+ organic clicks, and an average Google Search Console position of 8.2.
