...
Soy el Co-Founder y Full Stack Developer en **[Lulos Impulso Digital](https://tri-devs.vercel.app/)**, donde construimos plataformas web, aplicativos e impulsamos el SEO técnico y local para clientes como **[CIT](https://transitocitcali.com/)** • **[GastroGest Pro](https://gastrogestpro.com/)** • **[Tiffany Esthetic Group](https://tiffany-esthetic-group-ips-sas.vercel.app/)** hemos entregado resultados medibles — incluyendo 48,000+ impresiones de búsqueda, 708+ clics orgánicos, y una posición promedio de 8.2 en Google Search Console.
